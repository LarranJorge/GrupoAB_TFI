...
router.get(
  "/:id",
  [param("id", "El ID debe ser un número entero").isInt(), validarCampos],
...
router.post(
  ...
  [
    ...
    check(
      "id_obra_social",
      "El ID de la obra social es obligatorio y debe ser entero",
    )
      .notEmpty()
      .isInt(),
    validarCampos,
...
router.put(
  ...
  [
    ...
    check("documento", "El número de documento debe ser entero")
      .optional()
      .isInt(),
    check("apellido", "El apellido es obligatorio")
      .notEmpty()
