...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-06-2026 a las 17:59:35
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `generar_estadisticas_turnos` ()   BEGIN
    SELECT 
        (SELECT COUNT(*) FROM turnos_reservas) AS total_turnos,
        (SELECT COUNT(*) FROM turnos_reservas WHERE atendido = 1) AS turnos_atendidos,
...
(2, 2, 1, 2000, 'test', 5000.00, 1),
(3, 3, 3, 3000, 'test', 10000.00, 1),
(4, 4, 4, 4000, 'test', 15000.00, 1);
...
(4, 'OSUNER 3', 'OSU', 0.90, 0, 1),
(5, 'PAMI', 'test', 0.01, 0, 0);
...
(27, 1, 1, 1, '2026-06-22 13:20:00', 4500.00, 0, 1),
(28, 1, 1, 1, '2026-06-22 13:20:00', 4500.00, 0, 1),
(29, 1, 1, 1, '2026-06-25 10:00:00', 4500.00, 0, 0),
(30, 1, 1, 1, '2026-06-25 10:00:00', 4500.00, 0, 1);
...
(7, '41000113', 'Aguirre', 'Brian', 'agubri@correo.com', '2dfa174ae2688ec55d00f57c5a0a7783ba1f0e2981ab7df9f1cf933686c15274', '', 1, 1),
...
(13, '40123456', 'Gomez', 'Maria Laura', 'paciente.actualizado22@mail.com', '78b31c2f705d051930bc67198c290c9b1eb92f1379d2a932bcaa85c258d64d77', '', 2, 0);
...
--
ALTER TABLE `medicos`
  MODIFY `id_medico` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `medicos_obras_sociales`
--
ALTER TABLE `medicos_obras_sociales`
  MODIFY `id_medico_obra_social` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `obras_sociales`
--
ALTER TABLE `obras_sociales`
  MODIFY `id_obra_social` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `turnos_reservas`
  MODIFY `id_turno_reserva` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
